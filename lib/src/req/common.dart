...
class Url {
  ...
  static const URL = 'http://musicbrainz.org/ws/2/artist/?query=artist:fred%20AND%20type:group%20AND%20country:US&fmt=json';
  ...
  static String buildArtistSearch(String artist) {
    return BASE_URL  + PREFIX_ARTIST + URL_SEPARATOR + PREFIX_QUERY + "artist:" +  Uri.encodeComponent(artist) + JSON_SUFFIX;
  }
}
